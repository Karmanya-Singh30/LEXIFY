...
/**
 * @fileOverview Summarizes legal document into key points and obligations.
 *
...
const summarizeLegalDocumentPrompt = ai.definePrompt({
  ...
  prompt: `Summarize the following legal document, highlighting its key points and obligations:\n\n{{{documentText}}}`,
});
